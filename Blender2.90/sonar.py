...
bpy.ops.wm.open_mainfile(filepath=os.path.join(home_directory, "acousticimagegeneration_z.blend"))
...
def imageGeneration(num,k):   # num:number of iteration -> number of image
    ...
    savePath = os.path.join(save_directory, "rawimg_"+str(num+1)+"_"+str(k)+".png")
    savePath1 = os.path.join(save_directory, "resizeimg_"+str(num+1)+"_"+str(k)+".png")
    savePath2 = os.path.join(save_directory, "fanshaped_"+str(num+1)+"_"+str(k)+".png")
    savePath3 = os.path.join(save_directory, "hit"+str(num+1)+".jpg")
    savePath4 = os.path.join(save_directory, "hit_resize"+str(num+1)+".jpg")
    savePath5 = os.path.join(save_directory, "ele_"+str(num+1)+"_"+str(k)+".png")
    savePath6 = os.path.join(save_directory, "ele_resize_"+str(num+1)+"_"+str(k)+".png")
